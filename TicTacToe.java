...
public class TicTacToe {
 ...
 private static final String PLAYER_ONES_SYMBOL ="  X  ";
 private static final String PLAYER_TWOS_SYMBOL ="  O  ";
 ...
 public static void main(String[] args) {
		TicTacToe game = new TicTacToe("EMPTY");
		game.startGame();
}
 
 TicTacToe(String s){//initialized by constructor
 ...
 private void  askForUserNames(){
	 ...
	 currentPlayer=player==1?playerOne : playerTwo;//if else statement
 }
 
 private boolean isGameNotOver() {
	 return !(isBoardIsFull() || hasAnyPlayerWon());//ei duita case er jekunu ekta holei false return korbe,ar gameover hobe
 }
 
 private void  drawBoard(){
	 System.out.println("|-------|-------|-------|");
	 for(String chars[] : gameboard) {
		 System.out.printf("| %s | %s | %s |\n",chars[0],chars[1],chars[2]);//empty boshanu hoise
		 System.out.println("|-------|-------|-------|");
	 }
